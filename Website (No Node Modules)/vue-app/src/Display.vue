    ...
    methods: {
        ...
        async addOrganizations(){
            ...
            objects.forEach(object => {
                ...
                let conservative = object.article.bias.conservative;
                let liberal = object.article.bias.liberal;

                let total = conservative + liberal;

                conservative = conservative/total * 100;
                liberal = liberal/total * 100;

                conservative = Math.round(conservative * 100) / 100;
                liberal = Math.round(liberal * 100) /100;
        ...
        async showData(url){
            ...
            let conservative = responseJson.article.bias.conservative;
            let liberal = responseJson.article.bias.liberal;
